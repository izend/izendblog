...
_SEP_;
	...
	$sql= <<<_SEP_
INSERT INTO `${db_prefix}comment` (`comment_id`, `node_id`, `locale`, `created`, `user_id`, `ip_address`, `text`) VALUES
(1, 3, 'fr', '2011-12-27 09:39:02', 1, '127.0.0.1', '[p]J''essaye un commentaire avec une url : [url=http://www.izend.org]iZend[/url] ![/p]'),
(2, 3, 'fr', '2011-12-27 09:41:29', 1, '127.0.0.1', '[p][u]Citation[/u] :[/p][quote]J''essaye un commentaire avec une url : [url=http://www.izend.org]iZend[/url] ![/quote]\r\n[p]Non ! On peut mettre une [b]url[/b] dans un commentaire ?\r\n[br]Dis-moi pas que c''est pas vrai ![/p]'),
(3, 3, 'en', '2011-12-27 09:53:47', 1, '127.0.0.1', '[p]Let me try a comment with a url: [url=http://www.izend.org]iZend[/url]![/p]'),
(4, 3, 'en', '2011-12-27 09:57:21', 1, '127.0.0.1', '[p][u]Quote[/u]:[/p][quote]Let me try a comment with a url: [url=http://www.izend.org]iZend[/url]![/quote]\r\n[p]No! One can put a [b]url[/b] in a comment?\r\n[br]Don''t tell me it''s not true![/p]'),
(5, 17, 'fr', '2011-12-29 21:54:04', 1, '127.0.0.1', '[p]J''essaye un commentaire avec une url : [url=http://www.izend.org]iZend[/url] ![/p]'),
(6, 17, 'fr', '2012-01-12 13:04:42', 1, '127.0.0.1', '[p][u]Citation[/u] :[/p][quote]J''essaye un commentaire avec une url : [url=http://www.izend.org]iZend[/url] ![/quote]\r\n[p]Non ! On peut mettre une [b]url[/b] dans un commentaire ?\r\n[br]Dis-moi pas que c''est pas vrai ![/p]'),
(7, 17, 'en', '2011-12-29 21:54:04', 1, '127.0.0.1', '[p]Let me try a comment with a url: [url=http://www.izend.org]iZend[/url]![/p]'),
(8, 17, 'en', '2012-01-12 13:04:42', 1, '127.0.0.1', '[p][u]Quote[/u]:[/p][quote]Let me try a comment with a url: [url=http://www.izend.org]iZend[/url]![/quote]\r\n[p]No! One can put a [b]url[/b] in a comment?\r\n[br]Don''t tell me it''s not true![/p]');
_SEP_;
	if (!@mysql_query($sql, $db_conn)) {
		return false;
	}
...
_SEP_;
	...
	$sql= <<<_SEP_
INSERT INTO `${db_prefix}content_longtail` (`content_id`, `locale`, `file`, `image`, `width`, `height`, `icons`, `skin`, `duration`, `autostart`, `repeat`) VALUES
(1, 'fr', '/files/sounds/smoke.mp3', NULL, 250, 30, 0, '/longtail/modieus.zip', 0, 0, 1),
(1, 'en', '/files/sounds/smoke.mp3', NULL, 250, 30, 0, '/longtail/modieus.zip', 0, 0, 1),
(2, 'fr', 'http://www.youtube.com/watch?v=BeP80btBxIE', NULL, 320, 272, 0, '/longtail/modieus.zip', 0, 0, 0),
(2, 'en', 'http://www.youtube.com/watch?v=BeP80btBxIE', NULL, 320, 272, 0, '/longtail/modieus.zip', 0, 0, 0),
(5, 'fr', '/files/sounds/smoke.mp3', NULL, 250, 30, 0, '/longtail/modieus.zip', 0, 0, 1),
(5, 'en', '/files/sounds/smoke.mp3', NULL, 250, 30, 0, '/longtail/modieus.zip', 0, 0, 1),
(6, 'fr', 'http://www.youtube.com/watch?v=BeP80btBxIE', NULL, 320, 272, 0, '/longtail/modieus.zip', 0, 0, 0),
(6, 'en', 'http://www.youtube.com/watch?v=BeP80btBxIE', NULL, 320, 272, 0, '/longtail/modieus.zip', 0, 0, 0);
_SEP_;
	if (!@mysql_query($sql, $db_conn)) {
		return false;
	}
